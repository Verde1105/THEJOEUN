...
/**
 * Servlet implementation class TodayTest01
 */
@WebServlet("/TodayTest01")
public class TodayTest01 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd = request.getRequestDispatcher("TodayTest02");
