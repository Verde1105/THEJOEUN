...
public class ImplementMember implements Member {
	...
	public Boolean insertData(User user) {
		String query = "INSERT INTO "+tableName+" (ID, PW, balance, accountNum)"
				 		+" VALUES('"+user.getId()+"','"+user.getPw()+"',"+user.getBalance()+",'"+user.getAccountNum()+"')";
		System.out.println("SQL : "+query);
